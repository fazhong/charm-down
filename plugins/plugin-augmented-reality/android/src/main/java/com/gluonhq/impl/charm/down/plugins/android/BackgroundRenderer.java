...
public class BackgroundRenderer {
    ...
    private static final Logger LOG = Logger.getLogger(BackgroundRenderer.class.getName());
    ...
    /**
     * Allocates and initializes OpenGL resources needed by the background
     * renderer. Must be called on the OpenGL thread, typically in {@link GLSurfaceView.Renderer#onSurfaceCreated(GL10,
     * EGLConfig)}.
     *
    ...
    public void createOnGlThread(Context context) throws IOException {
        ...
        if (AndroidBridge.debug) {
            LOG.log(Level.INFO, "BGRenderer created, textureId = " + textureId
                + ", vertexShader = " + vertexShader + ", fragmentShader = "
                + fragmentShader + ",qpp = " + quadPositionParam + "qtp = " + quadTexCoordParam);
        }
    }

    /**
     * Draws the AR background image. The image will be drawn such that virtual
     * content rendered with the matrices provided by
     ...
     * will accurately follow static physical objects. This must be called
     * <b>before</b> drawing virtual content.
     *
    ...
    public void draw(Frame frame) {
        ...
        if (frame.hasDisplayGeometryChanged()) {
            if (AndroidBridge.debug) LOG.log(Level.INFO, "Frame changed");

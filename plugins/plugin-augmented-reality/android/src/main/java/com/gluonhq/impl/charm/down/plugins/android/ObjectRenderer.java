...
public class ObjectRenderer {
    ...
    private static final Logger LOG = Logger.getLogger(ObjectRenderer.class.getName());
     ...
     * @param diffuseTextureAssetName Name of the PNG file containing the
     * diffuse texture map.
    ...
    public void createOnGlThread(Context context, String objAssetName, String diffuseTextureAssetName)
        ...
        createOnGlThread(context, obj, diffuseTextureAssetName, null);
    }
     ...
     * @param context Context for loading the shader and below-named model and
     * texture assets.
     * @param obj The OBJ file containing the model geometry.
     * @param diffuseTextureAssetName Name of the PNG file containing the
     * diffuse texture map.
     * @param materialName Name of the material
     * @throws java.io.IOException
     */
    public void createOnGlThread(Context context, Obj obj, String diffuseTextureAssetName, String materialName)
            throws IOException {

        objName = materialName;
        ...
        // Read the texture.
        if (AndroidBridge.debug) LOG.log(Level.INFO, "Adding texture: " + diffuseTextureAssetName);
        Bitmap textureBitmap;
        try {
            int color = Color.parseColor(diffuseTextureAssetName);
            textureBitmap = Bitmap.createBitmap(128, 128, Config.ARGB_8888);
            textureBitmap.eraseColor(color);
        } catch (Exception e) {
     ...
     *
     * @param blendMode The blending mode. Null indicates no blending (opaque
     * rendering).
     */
     ...
     *
     * @param modelMatrix A 4x4 model-to-world transformation matrix, stored in
     * column-major order.
     * @param scaleFactor A separate scaling factor to apply before the
     * {@code modelMatrix}.
    ...
    public void rotateModelY(float angle) {
        Matrix.rotateM(this.modelMatrix, 0, angle, 0f, 1f, 0f);
    }

    public void rotateModelZ(float angle) {
        Matrix.rotateM(this.modelMatrix, 0, angle, 0f, 0f, 1f);
    }
     ...
     * @param specularPower Surface shininess. Larger values result in a
     * smaller, sharper specular highlight.
     */
     ...
     * @param colorCorrectionRgba Illumination intensity. Combined with diffuse
     * and specular material properties.
     * @see #setBlendMode(BlendMode)

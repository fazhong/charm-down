...
package com.gluonhq.impl.charm.down.plugins.android.scan.zxing;

import android.graphics.Color;
import com.gluonhq.impl.charm.down.plugins.android.scan.zxing.res.layout.CaptureActivityView;
import com.gluonhq.impl.charm.down.plugins.android.scan.zxing.result.ResultHandlerFactory;
import com.google.zxing.BarcodeFormat;
import com.google.zxing.DecodeHintType;
import com.google.zxing.Result;
import com.google.zxing.ResultMetadataType;
import com.google.zxing.ResultPoint;
import com.gluonhq.impl.charm.down.plugins.android.scan.zxing.camera.CameraManager;
import com.gluonhq.impl.charm.down.plugins.android.scan.zxing.result.ResultHandler;
...
import com.gluonhq.charm.down.plugins.android.AndroidBarcodeScanService;
...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback {
  ...
  public void onCreate(Bundle icicle) {
    ...
    if (intent != null && intent.hasExtra(AndroidBarcodeScanService.SCAN_VIEW_TITLE)) {
        String title = intent.getStringExtra(AndroidBarcodeScanService.SCAN_VIEW_TITLE);
        getActionBar().setTitle(title);
    }
    
    if (intent != null && intent.hasExtra(AndroidBarcodeScanService.SCAN_VIEW_LEGEND)) {
        legend = intent.getStringExtra(AndroidBarcodeScanService.SCAN_VIEW_LEGEND);
    }

    if (intent != null && intent.hasExtra(AndroidBarcodeScanService.SCAN_VIEW_RESULT)) {
        resultText = intent.getStringExtra(AndroidBarcodeScanService.SCAN_VIEW_RESULT);
    }

 ...
 */
package com.gluonhq.impl.charm.down.plugins.android.geotools;
...
public final class EarthGravitationalModel extends VerticalTransform {
     ...
     * A binary file with coefficient values read by {@link DataInput#readDouble} would
    ...
    public void load(final String filename) throws IOException {
        ...
        while ((line = in.readLine()) != null) {
            ...
            try {
                 ...
                 */
                throw new IOException(filename + in.getLineNumber(), cause);
            }
        }
        in.close();
        initialize();
